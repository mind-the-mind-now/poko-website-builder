...
{% wrapper tag="" %}
> {% link url="undefined", text="Signez notre Tribune : IA : levons-nous pour protéger l’esprit humain. L’initiative « Rise For The Mind »", linkType="internal", collection="undefined" %}
{% endwrapper %}
