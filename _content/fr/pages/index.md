...
{% wrapper tag="" %}
> {% link url="la-tribune", text="", linkType="internal", collection="pages" %}Signez notre Tribune : IA : levons-nous pour protéger l’esprit humain. L’initiative « Rise For The Mind »
{% endwrapper %}
